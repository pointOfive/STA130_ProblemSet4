...
sim %>% ggplot(aes(x=median_diff)) + geom_histogram(bins=30, color="black", fill="gray")
...
Complete this [One Sample Hypothesis Testing Practice Quiz](https://q.utoronto.ca/courses/277998/quizzes/279243) using this [Rmd file](https://jupyter.utoronto.ca/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2FpointOfive%2FSTA130_PracticeQuiz_OneSampleHypothesisTest_ABCD&urlpath=rstudio%2F&branch=main)

## Question 9

Complete this [Two Sample Hypothesis Testing Practice Quiz](https://q.utoronto.ca/courses/277998/quizzes/279244) using this [Rmd file](https://jupyter.utoronto.ca/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2FpointOfive%2FSTA130_PracticeQuiz_TwoSampleHypothesisTest_gratitude&urlpath=rstudio%2F&branch=main)
